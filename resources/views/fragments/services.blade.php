            ...
            <ul class="services">
                <li>
                    <div class="service-box">
                        <div class="icon-box">
                            <i class="fa fa-4x fa-truck" aria-hidden="true"></i>
                        </div>
                        <div class="details">
                ...
                <li>
                    <div class="service-box">
                        ...
                        <div class="details">
                            <div class="details-title">
                                <h4>Machine Tool Financing</h4>
                            </div>
                            <p>
                                Welding Machine <i class="fa fa-star" aria-hidden="true"></i> Lathe <i class="fa fa-star" aria-hidden="true"></i> Milling Machine <i class="fa fa-star" aria-hidden="true"></i> Saw <i class="fa fa-star" aria-hidden="true"></i> CNC Machine <i class="fa fa-star" aria-hidden="true"></i> Molding Equipment <i class="fa fa-star" aria-hidden="true"></i> Plasma Cutter <i class="fa fa-star" aria-hidden="true"></i> Waterjet Equipment <i class="fa fa-star" aria-hidden="true"></i> Woodworking Equipment <i class="fa fa-star" aria-hidden="true"></i> Stamping Press
                            </p>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="service-box">
                        <div class="icon-box">
                            <i class="fa fa-4x fa-medkit" aria-hidden="true"></i>
                        </div>
                        <div class="details">
                            <div class="details-title">
